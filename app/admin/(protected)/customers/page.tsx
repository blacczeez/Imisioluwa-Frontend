...
export default function AdminCustomersPage() {
  return (
    <div>
      <h1 className="font-serif text-3xl text-brand-dark mb-8">Customers</h1>
      <div className="bg-white p-12 rounded-xl border border-border text-center">
        <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-brand-50 flex items-center justify-center">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-brand-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
