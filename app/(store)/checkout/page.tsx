...
export default function CheckoutPage() {
  ...
  const inputClassName = "w-full px-3 py-2.5 sm:px-4 sm:py-3 text-sm border border-border rounded-lg focus:ring-2 focus:ring-brand-light focus:border-transparent transition-colors bg-white text-brand-dark";
